...
uuid_gb=00000000000000000000000000000004
uuid_gba=00000000000000000000000000000005
...
../target/debug/gisst-cli environment create --json-file ./records/gb/gb_gambatte_environment.json
../target/debug/gisst-cli environment create --json-file ./records/gba/gba_vba_environment.json
../target/debug/gisst-cli environment create --json-file ./records/n64/n64_gliden64_environment.json

# Create retroarch.cfg for nes / snes / etc
...
do
  ...
  case $folder in
      ...
      ;;
      gb)
          ../target/debug/gisst-cli work create --json-string "{\"work_id\":\"$work_uuid\", \"work_name\":\"$base\", \"work_version\":\"\",\"work_platform\":\"Game Boy\"}"
          ../target/debug/gisst-cli instance create --json-string "{\"instance_id\":\"$work_uuid\", \"environment_id\":\"$uuid_gb\", \"work_id\":\"$work_uuid\"}"
          ../target/debug/gisst-cli link object $uuid_retro_cfg $work_uuid --role config
      ;;
      gba)
          ../target/debug/gisst-cli work create --json-string "{\"work_id\":\"$work_uuid\", \"work_name\":\"$base\", \"work_version\":\"\",\"work_platform\":\"Game Boy Advance\"}"
          ../target/debug/gisst-cli instance create --json-string "{\"instance_id\":\"$work_uuid\", \"environment_id\":\"$uuid_gba\", \"work_id\":\"$work_uuid\"}"
          ../target/debug/gisst-cli link object $uuid_retro_cfg $work_uuid --role config
      ;;
      *)
          echo -n "unsupported platform $folder"
      ;;
  esac
