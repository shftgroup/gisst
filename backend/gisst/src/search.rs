...
impl MeiliIndexer {
    ...
    pub async fn init_indices(&self) -> Result<(), crate::error::SearchIndex> {
        ...
        instances
            ...
            .await?;
        instances
            .set_typo_tolerance(&meilisearch_sdk::settings::TypoToleranceSettings {
                enabled: Some(true),
        ...
        states
            .set_filterable_attributes(["work_platform", "creator_id", "instance_id", "work_name", "work_creator", "hidden"])
            .await?;
        states
            .set_sortable_attributes([
                "work_name",
