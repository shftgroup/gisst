...
pub struct SetUserRole {
    /// Creator ID. Obtain from the database or creator page
    pub id: Uuid,
...
pub struct AddCoreArgs {
    /// Should point to a .json file generated by gisst-dist.  That
...
pub struct UpgradeEnvironmentArgs {
    /// The previous name used for this core in gisst
    pub old_core_name: String,
    /// The previous version used for this core
    pub old_core_version: String,
    /// Should point to a .json file generated by gisst-dist.  That
    /// file should be in the same directory as the other build
    /// outputs.
...
pub enum Commands {
    ...
    /// Upgrade legacy environments with the given name and version to
    /// use the core name and version from the given core.json file.
    /// *Warning:* this will modify existing instanceobject and
    /// environment records, so back up your database first!
