...
First, get your administration API keys using =curl -H "Authorization: Bearer $MEILI_MASTER_KEY" http://localhost:7700/keys=.
...
export MEILI_SEARCH_KEY=other_key_from_that_curl_command
