...
export async function init(content_folder:string, content:string, entry_state:boolean, movie:boolean) {
  let v86:EmbedV86 = new EmbedV86({wasm_root:"v86",bios_root:"v86/bios", content_root:content_folder, container: <HTMLDivElement>document.getElementById("canvas_div")!});
  ui_state = new UI(
