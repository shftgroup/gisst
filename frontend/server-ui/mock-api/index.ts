  ...
  handler: (_req: MockApiHandlerRequest, res: MockApiHandlerResponse) => {
    setJSON(res, {
      cores: [
        {
          core_name: "fceumm",
          core_version: "some_hash",
          core_platform: "Nintendo Entertainment System",
        },
        {
          core_name: "gambatte",
          core_version: "some_hash",
          core_platform: "Nintendo Game Boy",
        },
        {
          core_name: "sameboy",
          core_version: "some_hash",
        ...
        },
        {
          ...
          core_version: "some_hash",
          core_platform: "Nintendo N64",
        },
        {
          core_name: "snes9x",
          core_version: "some_hash",
          core_platform: "Super Nintendo Entertainment System",
        },
        {
          core_name: "pcsx_rearmed",
          core_version: "some_hash",
          core_platform: "Sony Playstation",
        },
        {
          core_name: "NONE",
          core_version: "some_hash",
          core_platform: "Sega Genesis",
        },
        {
          core_name: "NONE",
          core_version: "some_hash",
          core_platform: "Sega Master System",
        },
        {
          core_name: "NONE",
          core_version: "some_hash",
          core_platform: "Sega Game Gear",
        },
        {
          core_name: "NONE",
          core_version: "some_hash",
          core_platform: "Sony Playstation 2",
        },
        {
          core_name: "NONE",
          core_version: "some_hash",
          core_platform: "Nintendo GameCube",
        },
        {
          core_name: "NONE",
          core_version: "some_hash",
          core_platform: "Atari 2600",
        },
        {
          core_name: "NONE",
          core_version: "some_hash",
          core_platform: "Intellivision",
        },
      ],
    });
  },
...
const resourcesHandler: MockHandler = {
  ...
  handler: (_req: MockApiHandlerRequest, res: MockApiHandlerResponse) => {
    ...
    res.setHeader(
      "Location",
      "/resources/96f7f017-0de4-4f03-9696-96c89d16c9d1",
    );
    res.end();
  },
};
