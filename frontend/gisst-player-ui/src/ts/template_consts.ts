export class UITemplateConst {
  public static readonly GRID_CONTAINER_EMBEDDED: string =
    "ui_grid_container_e";
  public static readonly GRID_CONTAINER_HEADLESS: string =
    "ui_grid_container_h";
  public static readonly STATE_LIST_OBJECT: string = "state_list_object";
  public static readonly EMULATOR_SINGLE_DIV: string = "emulator-single-div";
  public static readonly EMULATOR_CONTROL_BAR: string =
    "emulator_control_bar_e";
  public static readonly EMULATOR_OBJECTS_TABS_EMBEDDED: string =
    "emulator_object_tabs_e";
...
export class UIIDConst {
  ...
  static readonly EMU_ENTER_FULLSCREEN_BUTTON: string =
  ...
  static readonly EMU_REMOVE_LAST_SAVE_BUTTON: string =
    "remove_last_save_button";
  static readonly EMU_REMOVE_LAST_STATE_BUTTON: string =
    "remove_last_state_button";
  static readonly EMU_REMOVE_LAST_REPLAY_BUTTON: string =
    "remove_last_replay_button";
}
